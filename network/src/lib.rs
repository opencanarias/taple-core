...
mod tests {
    ...
    use log::debug;
    use message::Command;
    pub use message::{MessageReceiver, MessageSender, NetworkEvent};
    ...
    use commons::crypto::{Ed25519KeyPair, KeyGenerator, KeyMaterial, KeyPair};
    ...
    fn create_network() {
        ...
        rt.block_on(async {
            let mc1 = KeyPair::Ed25519(commons::crypto::Ed25519KeyPair::from_seed(
                format!("pepe").as_bytes(),
            ));
            let mc2 = KeyPair::Ed25519(commons::crypto::Ed25519KeyPair::from_seed(
