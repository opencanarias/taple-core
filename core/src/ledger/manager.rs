            ...
            match data {
                ...
                LedgerCommand::Genesis {
                    ...
                    let response = self
                        ...
                        .await;
                    log::debug!("Genesis response: {:?}", response);
                    match response {
                        Err(error) => match error {
                            LedgerError::ChannelClosed => {
                                log::error!("Channel Closed");
                ...
                LedgerCommand::ExternalEvent {
                    ...
                    let response = self
                        ...
                        .await;
                    log::debug!("ExternalEvent response: {:?}", response);
                    match response {
                        Err(error) => match error {
                            LedgerError::ChannelClosed => {
                                log::error!("Channel Closed");
                ...
                LedgerCommand::ExternalIntermediateEvent { event } => {
                    ...
                    log::debug!("ExternalIntermediateEvent response: {:?}", response);
                    match response {
                        Err(error) => match error {
                            LedgerError::ChannelClosed => {
                                log::error!("Channel Closed");
                ...
                LedgerCommand::GetLCE {
                    ...
                    log::debug!("FIRST GetLCE response: {:?}", response);
                    let response = match response {
                        Err(error) => match error.clone() {
                            LedgerError::ChannelClosed => {
                                log::error!("Channel Closed");
                    ...
                    log::debug!("SECOND GetLCE response: {:?}", response);
                ...
                LedgerCommand::GetNextGov {
                    ...
                    let response = self
                        ...
                        .await;
                    log::debug!("FIRST GetNextGov response: {:?}", response);
                    let response = match response {
                        Err(error) => match error.clone() {
                            LedgerError::ChannelClosed => {
                                self.token.cancel();
                    ...
                    log::debug!("SECOND GetNextGov response: {:?}", response);
